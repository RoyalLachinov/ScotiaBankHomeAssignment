...
public class PictureFullScreen extends AppCompatActivity {
    ...
    private ImageView imgFullScreen, expanded_image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(getIntent().getExtras().getString("url")).into(imgFullScreen);

        imgFullScreen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                zoomImageFromThumb(imgFullScreen, getIntent().getExtras().getString("url"));
            }
        });
    ...
    private void zoomImageFromThumb(final View thumbView, String url) {
        ...
        Picasso.get().load(url).fit().centerCrop().into(expandedImageView);
